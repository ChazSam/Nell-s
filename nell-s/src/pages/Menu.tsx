    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            Mozzarella cheese, herbs, bread crumbs, and olive oil are tossed and baked for this crowd-pleaser
          </p>
          <h4>$9.95</h4>
        </div>
                        <div>
          ...
          <p>
Stuffed with bacon, cheddar, and mozzarella cheese with sour cream on the side          </p>
          <h4>$15.95</h4>
        </div>                <div>
          <h3>Chicken Tenders</h3>
          <p>
A classic snack with BBQ sauce for dipping.         </p>
          <h4>$10.95</h4>
        </div>                <div>
          <h3>Jumbo Shrimp Cocktail</h3>
          <p>
A classic with lemon and cocktail sauce          </p>
          <h4>$15.95</h4>
        </div>                <div>
          <h3>Chicken Tenders</h3>
          <p>
A classic snack with BBQ sauce for dipping.          </p>
          ...
          <p>
6 shrimp with a dash of our special spices, lightly grilled – served w/ remoulade sauce, lemon, & rye bread garnish          </p>
          <h4>$15.95</h4>
        </div>                <div>
          <h3>Chilean Blue Mussels</h3>
          <p>
Veggies & Breadstick in a wonderful wine broth          </p>
          <h4>$16.95</h4>
        </div>                <div>
          ...
          <p>
With toasted garlic bread crisps          </p>
          <h4>$13.95</h4>
        </div>                <div>
          <h3>Lump Crab Cakes</h3>
          <p>
Pan-seared and served with chipotle sauce and lemon          </p>
          <h4>$15.95</h4>
        </div>                <div>
          ...
          <p>
Lightly coated in breadcrumbs served with crushed tomato basil marinara          </p>
          <h4>$8.95</h4>
        </div>                <div>
          <h3>Buffalo Hot Wings</h3>
          <p>
            Tossed in our buffalo sauce and served with celery sticks and bleu cheese sauce
          </p>
          ...
          <p>
Fresh cauliflower bites tossed. in a tangy buffalo sauce served with our homemade Peppercorn Ranch. Also available plain, with our sweet chili glaze          </p>
          <h4>$8.95</h4>
        </div>
        <div>
          <h3>The Greatest</h3>
          <p>
The name says it all! An assortment of ribs, fried shrimp, stuffed mushroom caps, chicken tenders, onion rings, and fresh vegetables with ranch, BBQ, and cocktail sauces for dipping          </p>
          <h4>$22.95</h4>
        </div>
        <div>
          <h3>Hot Giant Pretzel </h3>
          <p>
Savory treat served with hot cheesy dipping sauce          </p>
          <h4>$10.95</h4>
        </div>
        <div>
          <h3>Pot Stickers</h3>
          <p>
Pork and vegetable dumplings steamed and seared, served with sweet chili glaze          </p>
          <h4>$10.95</h4>
        </div>
      </div>
